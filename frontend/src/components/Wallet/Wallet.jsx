...
const Wallet = ({ onClose, title, children }) => {
  const modalRef = useRef();
  const [isVisible, setIsVisible] = useState(false);
  const { openWalletHistory } = useContext(EnginContext);
  ...
  return (
    <div className={classnames(styles.overlay, { [styles.show]: isVisible })}>
      <div
        className={classnames(styles.modalPage, {
          ...
          <div className={styles.content}>
            <header className={styles.header}>
              ...
              <div className={styles.icons}>
                ...
                <button onClick={() => openWalletHistory("transactions")}>
                  <i className={styles.icon}>
                    <svg
                      width="1em"
                      height="1em"
