...
const Withdraw = ({ onClose }) => {
  ...
  return (
    <div className={classnames(styles.overlay, { [styles.show]: isVisible })}>
      <div
        className={classnames(styles.withdrawPage, {
            ...
            <div className={styles.mainContent}>
              ...
              <div className={styles.withdrawFormWrapper}>
                {inputGroups.map(({ section, fields }) => (
                  <div key={section} className={styles.inputGroup}>
                    ...
                    {fields.map(
                      (
                        { name, type, placeholder, label, icon, options },
                        index
                      ) => (
              ...
              <div className={styles.footer}>
                <span className={styles.footerText}>
                  <b>Note:</b> Please carefully review your details before
                  withdrawing — incorrect information may result in lost funds.
                </span>
              </div>
            </div>
          </div>
